// Quick test with Fantastic Admin
...
try {
  ...
  await engine.launch();
  console.log('Navigating to https://admin.fantastic-admin.github.io ...');
  await engine.navigate('https://admin.fantastic-admin.github.io');
  ...
  console.log('\nAll nodes:');
  flat.forEach(n => console.log(`  ${'  '.repeat(n.depth)}${n.tag}: ${n.text} | ${n.selector}`));
} catch (e) {
